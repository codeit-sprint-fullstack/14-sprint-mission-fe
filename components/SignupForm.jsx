...
const initialValues = { email: '', nickname: '', password: '', passwordConfirm: '' };
const passwordRules = [
  ['length', '10자 이상'],
  ...
  return (
    <>
      <form className="space-y-6" onSubmit={handleSubmit} noValidate>
        ...
        <button className="primary-button w-full" type="submit" disabled={!isSubmittable}>회원가입</button>
      </form>
      ...
      <p className="mt-6 text-center text-sm font-medium text-gray-800">
        이미 회원이신가요? <Link className="text-primary underline" href="/login">로그인</Link>
      </p>
