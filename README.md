...
- [ ] 상품명, 상품 소개, 판매 가격, 태그에 대한 유효성 검사 Custom Hook을 만들어 주세요. 유효성 검사를 통과하지 않을 경우, 각 input에 빨간색 테두리와, 각각의 input 아래에 빨간색 에러 메시지를 보여주세요.
  - 유효한 조건
    - 상품명: 1자 이상, 10자 이내
...
#### 멘토님께 전할 메세지
중고마켓 백엔드의 경우 수업자료 만으로도 충분히 학습할 수 있었고, 구글링 하는 데에도 큰 어려움이 없었습니다. 이전에 말씀주셨던 controller, service, router 분리에 대해 조금 더 알아보고 분리해두었습니다. 데이터 흐름이 브라우저 - 라우터 - 컨트롤러 - 서비스 - DB 순으로 내려오고, 올라오는 것도 한 눈에 보여서 재밌었습니다.

다만 프론트엔드(리액트)의 경우 고질적인 문제가 있었습니다.
무슨... 뭘 어떻게 해야할지 잘 모르겠습니다. 아직도요!...

useState, useEffect, props를 넘기는 방법 등 각 개인의 요소(이론)적인 부분은 이해가 가는데, 실 개발에서 어떻게... 뭐 부터 해야하지? 하는 생각이 계속 들어 쉽게 작업에 들어가지 못했습니다. 실제로 고민하고 강의 다시 듣느라 하루 내내 한 자도 못 쳤습니다 (ㅠ) 어떤 흐름으로 개발이 흘러가야 할까요? 조언을 받고 싶습니다. 

후반으로 갈 수록 시간이 부족해 Registration page는 통째로 AI를 복붙해 가져왔습니다. 
item Page 부분도 AI의 도움을 많이 받았습니다.

costom hook은 큰 뼈대만 도움을 받고 나머지는 제가 작성했습니다. 
Registration page에 옮기는 것도 AI의 도움을 받았습니다.